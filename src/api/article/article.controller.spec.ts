...
describe("ArticleController", () => {
  ...
  describe("findOne", () => {
    it("Should return an article by given slug", async () => {
      ...
      expect(await controller.findOne("test-article", undefined)).toBe(articleRes);
    });
  });
  ...
  describe("create", () => {
    it("Should pass data create an article", async () => {
      ...
      const spyPrisma = jest.spyOn(prismaService.article, "create").mockResolvedValue(newArticle);
